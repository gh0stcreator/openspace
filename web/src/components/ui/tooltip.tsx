  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        // Поверхность как у меню: токены поповера, тень и кольцо. Штатная инверсия в тёмной теме
        // даёт белую плашку, а без кольца тёмная плашка сливается с полем под ней.
        className={cn(

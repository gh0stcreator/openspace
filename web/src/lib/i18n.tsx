...
const RU = {
  ...
  "composer.hint.blue": "Что строим?",
  "composer.hint.green": "Для чего ищем ход?",
  "composer.hint.violet": "О чём думаем?",
  "composer.hint.white": "Кого зовём и зачем?",
...
const EN: Record<keyof typeof RU, string> = {
  ...
  "composer.hint.blue": "What are we building?",
  "composer.hint.green": "What are we looking for a move for?",
  "composer.hint.violet": "What are we thinking about?",
  "composer.hint.white": "Who are we calling in, and why?",

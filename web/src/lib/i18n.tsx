...
const RU = {
  ...
  "skill.файлы": "Правит файлы",
  "skill.команды": "Запускает команды",
  "skill.веб": "Ищет в вебе",
  "card.engine": "Движок",
  "card.model": "Модель",
...
const EN: Record<keyof typeof RU, string> = {
  ...
  "skill.файлы": "Edits files",
  "skill.команды": "Runs commands",
  "skill.веб": "Searches the web",
  "card.engine": "Engine",
  "card.model": "Model",

...
const RU = {
  ...
  "feed.yourStep": "Шаг «{name}» ждёт вашего слова. Реплика без обращения закроет его",
  "feed.yourTopic": "Режим ждёт темы: ваша первая реплика его запустит",
  ...
  "mode.special": "Особый режим",
  "mode.specialMany": "Особые режимы",
  "mode.talk": "Без регламента",
  "mode.talkHint": "Шаги не двигаются: разговор идёт как в открытом. Для режимов, которые меняют не порядок ходов, а то, кем участники в нём выходят",
  "mode.steps": "Шаги",
  "mode.stepsHint": "## имя шага\nwho: роли: скептик, инженер\nhear: нет\nuntil: все ответят\nprompt: что они делают на этом шаге",
  "mode.stepsNote": "Шаг начинается строкой «## имя». who — кто говорит: «все», «роли: скептик, инженер» или «@ник». hear: нет — отвечают вслепую, не видя друг друга. until — чем шаг закрывается: «все ответят» или «человек».",
  "mode.stepOne": "шаг",
  "mode.stepFew": "шага",
  "mode.stepMany": "шагов",
  ...
  "step.blind": "вслепую",
  "step.aloud": "слышат",
  "step.waitAll": "ждём всех",
  "step.waitHuman": "ждём вас",
  "step.whoRoles": "Роли",
  "step.whoNames": "Поимённо",
...
const EN: Record<keyof typeof RU, string> = {
  ...
  "feed.yourStep": "Step “{name}” is waiting for your word. A message with no mention closes it",
  "feed.yourTopic": "The mode is waiting for a topic: your first message starts it",
  ...
  "mode.special": "Special mode",
  "mode.specialMany": "Special modes",
  "mode.talk": "No procedure",
  "mode.talkHint": "Steps do not advance: the talk runs like an open one. For modes that change not the order of turns but who the participants come out as",
  "mode.steps": "Steps",
  "mode.stepsHint": "## step name\nwho: роли: скептик, инженер\nhear: нет\nuntil: все ответят\nprompt: what they do on this step",
  "mode.stepsNote": "A step starts with «## name». who — who speaks. hear: нет — they answer blind. until — what closes the step.",
  "mode.stepOne": "step",
  "mode.stepFew": "steps",
  "mode.stepMany": "steps",
  "step.name": "step name",
  ...
  "step.blind": "blind",
  "step.aloud": "hearing",
  "step.waitAll": "all answer",
  "step.waitHuman": "you answer",
  "step.whoRoles": "Roles",
  "step.whoNames": "By name",
  "step.who": "Who speaks",

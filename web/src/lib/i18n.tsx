...
const RU = {
  ...
  "composer.hint.blue": "Что нужно сделать?",
  "composer.hint.green": "Для чего ищем ход?",
  "composer.hint.violet": "Какую мысль покрутим?",
  "composer.hint.white": "Что нужно выяснить?",
  ...
  "space.tune": "Динамика",
  "space.tuneNote": "Насколько охотно здесь вступают в разговор: «разговор», «разгон», «встреча» или «спор».",
...
const EN: Record<keyof typeof RU, string> = {
  ...
  "composer.hint.blue": "What needs making?",
  "composer.hint.green": "What are we looking for a move for?",
  "composer.hint.violet": "Which thought are we turning around?",
  "composer.hint.white": "What needs finding out?",
  ...
  "space.tune": "Dynamics",
  "space.tuneNote": "How readily people speak up here: «разговор», «разгон», «встреча» or «спор».",

...
Это описание цели, а не отчёт о состоянии: разделы 1–22 описывают, каким продукт должен стать,
и они намеренно впереди кода. Что уже сделано — в дорожной карте (раздел 23), в
...
**`0.2 — People`** ✓
Карточка участника, роль, амплуа, оппонент и домен, модель, умения, аватарка, дубль,
приглашение и увольнение, человек как участник.
*Результат: пользователь собирает собственную команду.*

**`0.3 — Modes`** — почти
Одиннадцать режимов, шаги, ответы вслепую, оркестрация, ведущий, пауза, вмешательство
человека, свод. Редактор — одно поле с текстом шагов. Не хватает создания режима из одной
строки намерения.
...
пространство сильнее режима, режим сильнее личного. Не хватает разделения правил

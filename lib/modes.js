 ...
 */
/**
 * Динамика места: насколько охотно здесь вступают в разговор и по чему меряют
 * собственную мысль. Числа — пороги внутренней мотивации из Inner Thoughts (CHI 2025),
 * где их калибровали на живых людях. Болтовня, разгон идей, рабочая встреча и разбор
 * чужого решения требуют разной готовности открыть рот, и одним набором тут не обойтись.
 *
 ...
 *
 * В файле режима стоит одно слово — имя динамики. Числа наружу не выходят: человеку
...
/** Динамика режима: у разговора своя, у работы — рабочая. */
...
function parse(name, raw) {
  ...
  return {
    ...
    // Динамика: разговор, разгон, встреча или спор. Пусто — по типу режима.

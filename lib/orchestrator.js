    ...
    this.enqueue(room, () => this.turn(room, name, {
      step: {
        ...
        prompt: 'Разговор встал. Пройди по тому, что было с твоего прошлого захода, и найди '
          ...
          + 'вопрос задали и оставили без ответа.\n\nНазови это списком и тегни тех, чьё это. '
          + 'Спор не пересказывай, подтверждения не проси, за других не делай.\n\nВсё закрыто '
          + 'и ничего не потерялось — ответь [skip] и ничего больше.',
      },
    }));
  }

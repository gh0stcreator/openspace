...
export class Orchestrator {
  ...
  nextStep(room) {
    ...
    // Граница шага — тихой строкой в ленте: в длинном разговоре по ней видно, где
    // кончился один шаг и начался другой. Только имя: номер шага и «вслепую» — это
    // состояние режима, ему место в строке управления, а не посреди разговора.

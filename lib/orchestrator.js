...
export class Orchestrator {
  ...
  /**
   * Позвать Сборщика, если с его прошлого хода накопилось, что собирать. Условие — не слово
   * в реплике, а состояние работы: сколько реплик прошло с тех пор, как он в последний раз
   * что-то сводил. Право промолчать у него есть, и пустой заход ему ничего не стоит.
   */
  assemble(room) {
    ...
    this.enqueue(room, () => this.turn(room, name, {
      step: {
        ...
        hear: true,
        until: 'человек',
        prompt: 'Разговор встал. Посмотри, что накопилось с твоего прошлого захода: правки, '
          + 'куски, решения, найденные источники.\n\nЕсть что свести в вещь — сведи и положи '
          + 'в рабочую папку, а в чат напиши две строки: где лежит и что изменилось. Спор '
          + 'не пересказывай и подтверждения не проси.\n\nСобирать нечего или всё уже собрано — '
          + 'ответь [skip] и ничего больше.',
      },
    }));
  }

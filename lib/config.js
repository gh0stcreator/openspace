...
export const DEFAULTS = {
  ...
  catchUp: 25,
  // Кто отвечает человеку, когда тот написал без тега. Отвечают по очереди, каждый
  // следующий уже видит реплики предыдущих. Пусто — первый в команде.
  defaultResponders: [],
...
export function loadConfig(root, overrides = {}) {
  ...
  const cfg = {
    ...
    ...onDisk,
    ...overrides,
    agents: { ...DEFAULTS.agents, ...(onDisk.agents ?? {}) },
  };

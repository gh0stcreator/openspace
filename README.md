...
| Обсудить вопрос без заранее выбранного подхода | Опенспейс |
| Получить несколько разных решений, а не одно общее | ⚫ Чёрная |

В каждой комнате свой состав, свой уклад и своя готовность вступать в разговор.
Комнату выбирают карточкой на пустом экране или списком в строке под полем ввода;
у каждой своя лента и своя память, и переход — это переход, а не переключение режима.

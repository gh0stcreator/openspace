...
| Ситуация | Комната |
| --- | --- |
| Готовое надо проверить на прочность: где порвётся, чего не учли | 🔴 Красная |
| Нужно написать, переписать или собрать вещь | 🔵 Синяя |
| Очевидное не годится, нужны ходы, которых не ждут | 🟢 Зелёная |
| Улучшение одного портит другое, и надо понять, что чему мешает | 🟣 Фиолетовая |
| Надо отделить то, что известно, от того, что все считают известным | ⚪ Белая |
| Просто поговорить | Опенспейс |
...
| Сущность | Сейчас |
| --- | --- |
| **Space** | комнаты по цвету: красная, синяя, зелёная, фиолетовая, белая и опенспейс |

...
| Готовое надо прожарить: где порвётся, чего не учли | 🔴 Красная |
| Закодить, спроектировать, собрать вещь | 🔵 Синяя |
| Разобраться, подумать, научиться — без решения на выходе | 🟣 Фиолетовая |
| Нужны конкретные люди под конкретную задачу | ⚪ Белая |
...
| Сущность | Сейчас |
| --- | --- |
| **Space** | комнаты по цвету: зелёная, красная, синяя, фиолетовая, белая и опенспейс |
